  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 xl:grid-cols-2">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h1 className="text-3x1 font-bold tracking-tighter sm:text-4x1 md:text-5x1 lg:text-6xl/none">
                    Effortless Time Off Management
                  </h1>
                  <p className="max-w-[600px] text-gray-500 md:text-xl ☐ dark: text-gray-400">
                    Streamline your company's time off requests, approvals, and
        ...
        <section className="w-full py-12 md: py-24 lg:py-32 lbg-gray-50">
          <div className="container px-4 md: px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3x1 font-bold tracking-tighter sm: text-4x1 md:text-5x1">
                  Key Features
                </h2>
                <p className="max-w-[900-px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
